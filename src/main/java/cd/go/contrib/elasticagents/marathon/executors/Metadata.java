...
public class Metadata {
    ...
    Metadata(String key, boolean required, boolean secure) {
    ...
    private Metadata(String key, ProfileMetadata metadata) {
        this.key = key;
    ...
    private static class ProfileMetadata {
        ...
        private ProfileMetadata(boolean required, boolean secure) {

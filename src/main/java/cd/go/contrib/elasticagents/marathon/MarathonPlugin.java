...
import cd.go.contrib.elasticagents.marathon.executors.*;
...
import static cd.go.contrib.elasticagents.marathon.Constants.PLUGIN_IDENTIFIER;

@Extension
public class MarathonPlugin implements GoPlugin {

    public static final Logger LOG = Logger.getLoggerFor(MarathonPlugin.class);

    private PluginRequest pluginRequest;
    private AgentInstances agentInstances;
    private final marathonClientFactory marathonClientFactory = new marathonClientFactory();

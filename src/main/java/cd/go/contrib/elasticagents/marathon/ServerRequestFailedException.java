...
public class ServerRequestFailedException extends Exception {
    ...
    static ServerRequestFailedException disableAgents(GoApiResponse response) {
        return new ServerRequestFailedException(response, "disable agents");
    }

    static ServerRequestFailedException deleteAgents(GoApiResponse response) {
        return new ServerRequestFailedException(response, "delete agents");
    }

    static ServerRequestFailedException listAgents(GoApiResponse response) {
        return new ServerRequestFailedException(response, "list agents");
    }

    static ServerRequestFailedException getPluginSettings(GoApiResponse response) {
